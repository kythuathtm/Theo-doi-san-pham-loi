...
const Login: React.FC<Props> = ({ onLogin, users, settings }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden text-slate-800 font-sans selection:bg-[#003DA5] selection:text-white p-4 sm:p-6">
       ...
       <div className={`relative z-10 w-full max-w-6xl transition-all duration-1000 ease-out transform ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        
        {/* Glass Card Container */}
        <div className="bg-white/70 backdrop-blur-2xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] rounded-[2.5rem] border border-white/60 ring-1 ring-white/50 relative overflow-hidden group flex flex-col md:flex-row min-h-[600px]">
            ...
            {/* LEFT COLUMN: Branding, Welcome, Footer (7/12) */}
            <div className="w-full md:w-7/12 p-8 sm:p-12 flex flex-col justify-between items-center text-center relative border-b md:border-b-0 md:border-r border-white/50">
                
                {/* Spacer for vertical centering balance */}
                <div className="flex-1 flex flex-col justify-center items-center w-full">
                    {/* Logo */}
                    <div className="w-32 h-32 bg-white/90 rounded-[2rem] flex items-center justify-center border border-white shadow-xl shadow-indigo-500/10 p-5 transform group-hover:scale-105 transition-transform duration-500 mb-8 relative backdrop-blur-sm animate-fade-in-up">
                        {settings.logoUrl ? (
                    ...
                    {/* WELCOME */}
                    <div className="mb-6 relative animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                        <p className="text-5xl sm:text-6xl font-black tracking-[0.1em] text-transparent bg-clip-text bg-gradient-to-br from-blue-600 via-indigo-500 to-blue-600 uppercase drop-shadow-sm">
                            WELCOME
                        </p>
                    ...
                    {/* Main Title Block */}
                    <div className="space-y-2 relative flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        <p className="text-xs font-bold tracking-[0.3em] text-slate-400 uppercase mb-2 opacity-80">
                            - HỆ THỐNG QUẢN LÝ -
                        </p>

                        <div className="text-[#003DA5] space-y-1">
                            <h1 className="text-2xl sm:text-3xl font-black uppercase leading-tight tracking-tight">
                        ...
                        <div className="h-1.5 w-24 bg-[#003DA5]/20 rounded-full mt-6 mx-auto"></div>
                    </div>
                </div>

                {/* Footer (Moved to Left Column) */}
                <div className="pt-6 text-center animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            ...
            {/* RIGHT COLUMN: Login Form (5/12) */}
            <div className="w-full md:w-5/12 p-8 sm:p-12 bg-white/40 flex flex-col justify-center relative shadow-inner">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-4 bg-white/80 border border-slate-200/60 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-[#003DA5]/50 focus:bg-white transition-all shadow-inner hover:bg-white"
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-12 py-4 bg-white/80 border border-slate-200/60 rounded-2xl text-sm font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-[#003DA5]/50 focus:bg-white transition-all shadow-inner hover:bg-white"
                        ...
                        <div className="flex items-center justify-between pt-2">
                            <label className="flex items-center cursor-pointer group select-none">
                                ...
                                <span className="ml-2.5 text-xs font-bold text-slate-500 group-hover:text-slate-700 transition-colors">Ghi nhớ</span>
                            </label>
                        ...
                        >
                            ...
                            {loading ? (
                                ...
                                <span className="relative z-10 flex items-center gap-2 tracking-wide uppercase text-base">
                                    ĐĂNG NHẬP <ArrowRightIcon className="w-5 h-5 opacity-80 group-hover/btn:translate-x-1 transition-transform" />
                                </span>
                            )}
                        </button>
                    </form>
